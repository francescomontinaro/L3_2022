...
system("Rscript --no-save check_heterozygosity_rate.R")
...
system("Rscript --no-save heterozygosity_outliers_list.R")
...
# system("awk '{ if ($8 >0.9) print $0 }' pihat_min0.2.genome>zoom_pihat.genome")
# 
